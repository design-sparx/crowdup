import {Button, Center, Container, createStyles, Group, Overlay, rem, Text, Title} from '@mantine/core';
...
const useStyles = createStyles((theme) => ({
  ...
  badge: {
    ...
    backgroundImage: theme.fn.gradient({from: theme.colors.green[3], to: theme.colors.lime[5], deg: 20}),
    fontWeight: 500
  }
}));
      ...
      <div className={classes.inner}>
        <Container>
          ...
          <Text size="lg" className={classes.description}>
            Join us and be part of something special. Together we can make a difference and bring your dreams to
            reality.
          </Text>
        </Container>
